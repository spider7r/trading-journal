...
export default function LoginPage({
    ...
    // Unwrap params in a way that works with the Promise type if needed, 
    // but for client components we might need to handle it differently or use `use` hook.
    // However, this is a Server Component by default in Next.js app dir unless 'use client' is at top.
    // Wait, I added 'use client' to use framer-motion. 
    // So I need to handle searchParams correctly. 
    // Actually, for client components, we use `useSearchParams` hook.
    // Let's refactor to use `useSearchParams`.

    // REFACTOR NOTE: Switching to useSearchParams for client component compatibility
